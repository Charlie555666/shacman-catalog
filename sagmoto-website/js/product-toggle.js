...
(function() {
  ...
  var productData = {
    "x9 4x4 dump truck": {
      ...
      features: [
        "All wheel drive, superior off-road capability",
    ...
    "9 series sweeper": {
      ...
      category: "Special Vehicle (Municipal)",
      engine: "Yuchai YC4D",
      hp: 140,
      torque: "480 N·m",
    ...
    "x6 dropside truck": {
      ...
      features: [
        ...
        "Special low-rolling resistance tires for fuel efficiency",
    ...
    "x6 sprinkler truck": {
      ...
      category: "Medium Duty Truck (Municipal)",
      engine: "Cummins ISD",
      hp: 210,
      torque: "800 N·m",
      transmission: "6-speed Manual",
      ...
      wheelbase: "3800 mm",
      cab: "Day cab",
      suspension: "Lightweight leaf-spring",
      features: [
        "Lightweight design chassis and frame",
    ...
    "x6 cement mixers truck": {
      ...
      category: "Medium Duty Truck (Special)",
      engine: "Cummins ISD",
      hp: 210,
      torque: "800 N·m",
      transmission: "6-speed Manual",
    ...
    "z3 tractor truck": {
      ...
      suspension: "4-point air suspension",
      features: [
        "Next-gen powertrain with intelligent electronic system",
    ...
    "x3s trailer truck": {
      ...
      features: [
        ...
        "Cab meets ECER29-03 collision standard"
      ]
    },
    "e3 tractor truck": {
    ...
    "x9 tow truck": {
      ...
      suspension: "Leaf-spring",
      features: [
        "Heavy-duty winch for vehicle recovery",
        "Maximum gradient of over 30%",
    ...
    "i5 compressor car": {
      ...
      category: "New Energy Vehicle (Sanitation)",
      engine: "Electric Drive Motor",
      hp: 120,
      torque: "700 N·m",
      transmission: "Single-speed reduction gear",
  ...
  function buildSpecPanel(card) {
    ...
    if (!data) {
      panel.innerHTML = '<div class="specs-loading">Specifications not available</div>';
      return panel;
    }

    var html = '<div class="specs-inner">';
    html += '<table class="specs-table">';
    html += '<tr><td class="specs-label">Category</td><td class="specs-value">' + data.category + '</td></tr>';
    html += '<tr><td class="specs-label">Engine</td><td class="specs-value">' + data.engine + '</td></tr>';
    html += '<tr><td class="specs-label">Horsepower</td><td class="specs-value">' + data.hp + ' HP</td></tr>';
    html += '<tr><td class="specs-label">Torque</td><td class="specs-value">' + data.torque + '</td></tr>';
    html += '<tr><td class="specs-label">Transmission</td><td class="specs-value">' + data.transmission + '</td></tr>';
    html += '<tr><td class="specs-label">Drive</td><td class="specs-value">' + data.drive + '</td></tr>';
    if (data.range) {
      html += '<tr><td class="specs-label">Range</td><td class="specs-value highlight">' + data.range + '</td></tr>';
    } else {
      html += '<tr><td class="specs-label">GCW</td><td class="specs-value">' + data.gcw + '</td></tr>';
    }
    html += '<tr><td class="specs-label">Wheelbase</td><td class="specs-value">' + data.wheelbase + '</td></tr>';
    html += '<tr><td class="specs-label">Cab</td><td class="specs-value">' + data.cab + '</td></tr>';
    html += '<tr><td class="specs-label">Suspension</td><td class="specs-value">' + data.suspension + '</td></tr>';
    if (data.charging) {
      html += '<tr><td class="specs-label">Charging</td><td class="specs-value highlight">' + data.charging + '</td></tr>';
    }
    html += '</table>';

    html += '<div class="specs-features">';
    html += '<h5>Key Features</h5>';
    html += '<ul>';
